        ...
        children: [
          SizedBox(
            ...
            child: TabBar(
              ...
              tabs: [
                Text(AppLocalization.of(context).getTranslated("text_tab1_favorites")),
                Text(AppLocalization.of(context).getTranslated("text_tab2_favorites")),
                Text(AppLocalization.of(context).getTranslated("text_tab3_favorites")),
              ],
            ),
          ),
          Flexible(
